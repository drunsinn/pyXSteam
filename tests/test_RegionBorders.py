...
import unittest
from pyXSteam.RegionBorders import pB23_T, TB23_p, pB2bc_h, hB2bc_p, hB2bc_s
...
class BordersTester(unittest.TestCase):
    ...
    def test_R7_97_B23(self):
        ...
        error = abs(pB23_T(0.623150000e3) - 0.165291643e2)
        self.assertLess(error, self.max_error, "Error for p_B23(T) to big")

        error = abs(TB23_p(0.165291643e2) - 0.623150000e3)
    ...
    def test_R7_97_B2bc(self):
        ...
        error = abs(pB2bc_h(0.3516004323e4) - 0.100000000e3)
        self.assertLess(error, self.max_error, "Error for pB2bc(T) to big")

        error = abs(hB2bc_p(0.100000000e3) - 0.3516004323e4)
    ...
    def test_SR2_01_B2bc(self):
        ...
        error = abs(hB2bc_s(7.0) - 3376.437884)
