...
class BordersTester(unittest.TestCase):
    ...
    def test_R7_97_B23(self):
        ...
        self.assertLess(error, self.max_error, "Error for p_B23(T) too big")

        error = self._calc_err(RB.TB23_p(0.165291643e2), 0.623150000e3)
        self.assertLess(error, self.max_error, "Error for T_B23(p) too big")
    ...
    def test_R7_97_B2bc(self):
        ...
        self.assertLess(error, self.max_error, "Error for pB2bc(T) too big")

        error = self._calc_err(RB.hB2bc_p(0.100000000e3), 0.3516004323e4)
        self.assertLess(error, self.max_error, "Error for hB2bc(p) too big")
    ...
    def test_SR2_01_B2bc(self):
        ...
        self.assertLess(error, self.max_error, "Error for hB2bc(s) too big")
    ...
    def test_SR4_04_B13(self):
        ...
        self.assertLess(error, self.max_error, "Error for hB13(s) too big")
