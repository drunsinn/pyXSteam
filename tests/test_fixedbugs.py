# -*- coding: utf-8 -*-
"""
This module tests the situations that where reported directly via github issues or
via bug reports in related projects
"""
...
class FixedBugsTester(unittest.TestCase):
    """Test for all issues and bug reports"""
