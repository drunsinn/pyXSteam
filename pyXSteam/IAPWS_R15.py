...
def tc_ptrhocp_R15(p, T, rho, my, cp, cv):
    ...
    thcond_star = 1E-3 # Page 3 / EQ 4 in [W/Km]
    ...
    zeta_T_roh = 'TODO IAPWS Industrial Formulation 1997 for the Thermodynamic Properties of Water and Steam [8]'
    ...
    thcond_dash = tc0 * tc1 + tc2 # Page 5 / EQ 15
    return thcond_dash * thcond_star
