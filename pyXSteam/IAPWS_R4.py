...
def myHW_rhoT_R4(rho: float, T: float) -> float:
    ...
    B = [
        ...
        [0.3509007, 1.315436, 1.297752, 1.353448, 0.0, 0.0],
        [-0.2847572, -1.037026, -1.287846, 0.0, 0.0, -0.02148229],
        [0.07013759, 0.4660127, 0.2292075, -0.4857462, 0.0, 0.0],
        [0.01641220, -0.02884911, 0.0, 0.1607171, 0.0, -0.009603846],
        [-0.01163815, -0.008239587, 0.0, 0.0, 0.0, 0.004559914],
        [0.0, 0.0, 0.0, -0.003886659, 0.0, 0.0],
    ]
    temp_sum = 0
    for i in range(0, 6):
    ...
    my_1_dash = math.exp(rho_dash * temp_sum)
